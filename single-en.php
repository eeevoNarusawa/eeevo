<?php get_header(); ?>
  ...
  <div class="news-wrap">
    ...
    <div class="tabs">
      ...
      <a href="<?php echo home_url(); ?>/news/"><label class="tab_item" for="all">2020</label></a>
      <!-- <input id="programming" type="radio" name="tab_item"> -->
      <a href="<?php echo home_url(); ?>/news/"><label class="tab_item" for="programming">2019</label></a>
    </div>
  </div>
